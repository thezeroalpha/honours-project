...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.7]{outages-across-week.png}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.9]{causes-vs-duration-hr-ranges.png}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.8]{severity-vs-users-affected.png}
